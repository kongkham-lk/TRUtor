...
#include "service/MessageService.h" // Now includes MessageService
...
// --- Menu Functions (Modified to include MessageService) ---
...
int main() {
    ...
    // ... (rest of the test logic, which is fine to keep) ...
    // --- Testing User Logic ---
    ...
    // --- Testing Course Logic (from original code) ---
...
// Student Menu Function (Modified)
void showStudentMenu(const Student& student, AuthService& auth, MessageService& msgService) {
    while (true) {
        int choice;
